			...
			<div className='bodyMap flex justify-center'>
				<div className='container flex gap-20 max-w-[1400px]'>
					<div className='Map flex flex-col items-center'>
						<div className='title_map uppercase h-[65px] w-[400px] bg-[#465373] font-bold text-[#E4E9EF] flex justify-center items-center mb-20'>
							Карта москвы
						</div>
						<img src={map} />
					</div>
					<div className='MapInfo flex flex-col items-center'>
						<div className='titleInfo text-[#1C2D4A] text-5xl mb-20 font-bold'>
							Lorem Ipsum
						</div>
