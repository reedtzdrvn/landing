		...
		<>
			<div className='footer bg-[#465373] h-[300px] mt-40 flex justify-center'>
				<div className='container w-[1400px] flex justify-between'>
					...
					<div className='mt-10 text-[#ADADAD] text-2xl'>
						<div>Проект выполняли:</div>
						<div>Мельников К.Д. 221-377</div>
						<div>Даришев Р.К. 221-363</div>
						<div>Марков Д.А. 221-363</div>
						<div>Маркин Н.В. 221-363</div>
						<div>Белянин А.Н. 221-171</div>
					</div>
				</div>
			</div>
		</>
